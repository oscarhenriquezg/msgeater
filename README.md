...
| **Análisis por consola** | `msgeater --analyze correo.eml`: el mismo análisis sin abrir ventana y sin servidor gráfico (`--json` para encadenarlo). Revisar un buzón entero no se hace correo a correo. [Guía](docs/USER-GUIDE.md#11-analizador-de-línea-de-comandos-sin-ventana) |
